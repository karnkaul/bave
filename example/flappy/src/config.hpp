...
struct Config {
	...
	bave::TextHeight score_text_height{bave::TextHeight{80}};	  // NOLINT
	bave::Rgba game_over_text_rgba{bave::Rgba::from(0xcc4400ff)}; // NOLINT
	bave::TextHeight game_over_text_height{bave::TextHeight{80}}; // NOLINT
	float restart_text_y{-200.0f};								  // NOLINT
	bave::Rgba restart_text_rgba{bave::black_v};				  // NOLINT
	bave::TextHeight restart_text_height{bave::TextHeight{40}};	  // NOLINT
